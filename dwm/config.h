...
static const int showbar            = 1;        // 0 means no bar ! CHANGED FROM DEFAULT
...
static const char *clipmenucmd[] = { "clipmenu", "-m", "0", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_accnt, "-sf", col_gray4, NULL };
...
static const Key keys[] = {
    ...
    { MODKEY, XK_s, spawn, SHCMD("exec ss") },
    { MODKEY|ShiftMask, XK_s, spawn, SHCMD("exec ~/.hidden/scripts/screenshot_crop.sh") },
    { MODKEY|ShiftMask, XK_equal, spawn, SHCMD("exec ~/.hidden/scripts/emoji_picker.sh") },
